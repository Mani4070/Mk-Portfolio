...
export default function Navbar() {
    ...
    return (
        <>
            ...
            <nav
                ref={navRef}
                className={`fixed left-0 top-0 h-full w-64 bg-white/90 dark:bg-darkTheme/90 backdrop-blur-lg border-r border-gray-200 dark:border-white/10 z-40 transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'
                    }`}
            >
                <div className="flex flex-col h-full p-6">
                    ...
                    <div className="mb-8">
                        <a href="#top" onClick={(e) => handleNavClick(e, 'top')}>
                            ...
                            <img src="/assets/venture.png" alt="Logo" className="w-48 hidden dark:block" />
                        </a>
                    </div>
                    ...
                    <ul className="flex flex-col gap-2 flex-1 font-Ovo">
                        <li>
                            <a
                                ...
                                className={`block px-4 py-2 rounded-lg transition ${activeSection === 'top'
                                        ? 'bg-gradient-to-r from-teal-600 to-emerald-700 dark:from-teal-500 dark:to-emerald-600 text-white shadow-md'
                        ...
                        <li>
                            <a
                                ...
                                className={`block px-4 py-2 rounded-lg transition ${activeSection === 'about'
                                        ? 'bg-gradient-to-r from-teal-600 to-emerald-700 dark:from-teal-500 dark:to-emerald-600 text-white shadow-md'
                                        : 'hover:bg-lightHover dark:hover:bg-darkHover hover:text-gray-500 dark:hover:text-gray-300'
                                    }`}
                            >
                        ...
                        <li>
                            <a
                                ...
                                className={`block px-4 py-2 rounded-lg transition ${activeSection === 'skills'
                                        ? 'bg-gradient-to-r from-teal-600 to-emerald-700 dark:from-teal-500 dark:to-emerald-600 text-white shadow-md'
                                        : 'hover:bg-lightHover dark:hover:bg-darkHover hover:text-gray-500 dark:hover:text-gray-300'
                                    }`}
                            >
                        ...
                        <li>
                            <a
                                ...
                                className={`block px-4 py-2 rounded-lg transition ${activeSection === 'work'
                                        ? 'bg-gradient-to-r from-teal-600 to-emerald-700 dark:from-teal-500 dark:to-emerald-600 text-white shadow-md'
                                        : 'hover:bg-lightHover dark:hover:bg-darkHover hover:text-gray-500 dark:hover:text-gray-300'
                                    }`}
                            >
                        ...
                        <li>
                            <a
                                ...
                                className={`block px-4 py-2 rounded-lg transition ${activeSection === 'experience'
                                        ? 'bg-gradient-to-r from-teal-600 to-emerald-700 dark:from-teal-500 dark:to-emerald-600 text-white shadow-md'
                                        : 'hover:bg-lightHover dark:hover:bg-darkHover hover:text-gray-500 dark:hover:text-gray-300'
                                    }`}
                            >
                        ...
                        <li>
                            <a
                                ...
                                className={`block px-4 py-2 rounded-lg transition ${activeSection === 'contact'
                                        ? 'bg-gradient-to-r from-teal-600 to-emerald-700 dark:from-teal-500 dark:to-emerald-600 text-white shadow-md'
                                        : 'hover:bg-lightHover dark:hover:bg-darkHover hover:text-gray-500 dark:hover:text-gray-300'
                                    }`}
                            >
